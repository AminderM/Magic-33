...
PLANS = [
    ...
    },
    {
        ...
        "price": 999,
        "default_seats": 50,
        "description": "Complete TMS solution with all features",
        "features": [
            "All Pro features",
            "Equipment Management - Full CRUD operations with availability tracking",
            "Fleet Management - Comprehensive fleet oversight and analytics",
            "Driver Management - Add, edit, delete drivers with full profiles",
            "Order Management - Active loads and load history with status tracking",
            "Live GPS Tracking - Real-time vehicle and driver location monitoring",
            "Booking Management - Quote requests and booking approvals",
            "Company Profile - Split view with users/drivers/documents management",
            "Document Version History - Track all document versions with 10MB uploads",
            "User Management - Role-based access control (Fleet Owner, Driver, Dispatcher, AR, AP, HR)",
            "Brand Adaptive Theming - Auto-generate color schemes from company logo",
            "Export Downloads - CSV, Excel, and JSON export for all data",
            "ELD Integration - Samsara, Motive, Geotab, Verizon Connect, Omnitracs, Trimble",
            "AI Rate Confirmation - Intelligent pricing recommendations",
            "Apps Marketplace - Integrate third-party applications",
            "Mobile Driver Interface - Full mobile app for drivers",
            "Location Tracking - Advanced geofencing and route optimization",
            "Email Verification System - Secure user onboarding",
            "WebSocket Support - Real-time updates across all features",
            "Currency Validation - Strict numerical formatting for rates",
            "Up to 50 users",
